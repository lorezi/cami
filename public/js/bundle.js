...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZG9leHYiLCJhIjoiY2syb3N3a2NwMDdqMzNodGRid20zd2pvcSJ9.sSevBGM-4Pq6irmRze4ySg';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:9009/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:9009/api/v1/users/logout'
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:9009/api/v1/users/updatePassword' : 'http://127.0.0.1:9009/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            res = _context.sent;
            msg = type === 'password' ? 'Password updated successfully' : 'Data updated successfully';
...
var stripe = Stripe('pk_test_51HETfBK0bxcEMyTZ3LqswZUi9OElrfKOMKIgIhU3NemDDkQynKGz8SRLp32Ger2i5cdQP9SR1CRuRvhrTP9Vyi0a002XePSUeK');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:9009/api/v1/bookings/checkout-session/".concat(tourId));
...
if (updatePasswordForm) updatePasswordForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
